...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary brand colors for Langsapost
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
      ...
      fontFamily: {
        ...
        indonesia: ['Noto Sans', 'sans-serif'],
      },
      fontSize: {
      ...
      backgroundImage: {
        ...
        'hero-pattern': "url('/images/backgrounds/hero-bg.jpg')",
        'newsletter-pattern': "url('/images/backgrounds/newsletter-bg.jpg')",
      },
      typography: {
        DEFAULT: {
          css: {
